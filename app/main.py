...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000","https://mailserver-1z3d.onrender.com/","https://mbayescientist.github.io"],  # Permet toutes les origines (en développement, vous pouvez spécifier 'http://localhost:3000')
